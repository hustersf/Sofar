...
import com.sofar.chart.buffer.HorizontalBarBuffer;
        ...
        if (!dataSet.isStacked()) {
          ...
          while (index < dataSet.getEntryCount() * mAnimator.getPhaseX()) {
            ...
            if (vals == null) {
              ...
              float valueTextWidth = Utils.calcTextWidth(mValuePaint, formattedValue);
              posOffset =
                (drawValueAboveBar ? valueOffsetPlus : -(valueTextWidth + valueOffsetPlus));
              negOffset =
                (drawValueAboveBar ? -(valueTextWidth + valueOffsetPlus) : valueOffsetPlus);
