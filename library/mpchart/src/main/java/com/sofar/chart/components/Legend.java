...
public class Legend extends ComponentBase {
  ...
  /**
   * Entries that will be appended to the end of the auto calculated entries after calculating
   * the legend.
   * (if the legend has already been calculated, you will need to call notifyDataSetChanged() to
