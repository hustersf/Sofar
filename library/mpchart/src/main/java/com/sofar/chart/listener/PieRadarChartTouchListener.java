...
import com.sofar.chart.charts.PieRadarChartBase;
...
public class PieRadarChartTouchListener extends ChartTouchListener<PieRadarChartBase<?>> {
  ...
  private float calculateVelocity() {
    ...
    // Look for a sample that's closest to the latest sample, but not the same, so we can deduce
    // the direction
  ...
  public void computeScroll() {
    ...
    mChart
      .setRotationAngle(mChart.getRotationAngle() + mDecelerationAngularVelocity * timeInterval);
