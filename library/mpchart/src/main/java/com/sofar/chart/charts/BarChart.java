...
import com.sofar.chart.highlight.BarHighlighter;
...
import com.sofar.chart.renderer.BarChartRenderer;
...
public class BarChart extends BarLineChartBase<BarData> implements BarDataProvider {
   ...
   * found in the charts data.  Performance-intensive code should use void getBarBounds
   * (BarEntry, RectF) instead.
   *
   * @param e
   * @return
   */
  ...
  /**
   * The passed outputRect will be assigned the values of the bounding box of the specified
   * Entry in the specified DataSet.
   ...
   * highlight single values (relevant
   * only for stacked). If enabled, highlighting operations will highlight the whole bar, even if
   * only a single stack entry
   * was tapped.
   * Default: false
   *
   * @param enabled
  ...
  /**
   * Adds half of the bar width to each side of the x-axis range in order to allow the bars of
   * the barchart to be
   * fully displayed.
   * Default: false
   *
   ...
   * their entries.
   * Previously set x-values of entries will be overwritten. Leaves space between bars and
   * groups as specified
   * by the parameters.
