...
import com.sofar.chart.highlight.PieHighlighter;
import com.sofar.chart.interfaces.datasets.IPieDataSet;
import com.sofar.chart.renderer.PieChartRenderer;
...
public class PieChart extends PieRadarChartBase<PieData> {
  ...
  private void calcAngles() {
    ...
    if (hasMinAngle) {
      // Correct bigger slices by relatively reducing their angles based on the total angle
      // needed to subtract
  ...
  /**
   * Sets the offset the center text should have from it's original position in dp. Default x =
   * 0, y = 0
   *
   * @param x
   * @param y
