...
import com.sofar.chart.data.BubbleEntry;
import com.sofar.chart.highlight.Highlight;
import com.sofar.chart.interfaces.dataprovider.BubbleDataProvider;
...
public class BubbleChartRenderer extends BarLineScatterCandleBubbleRenderer {
  ...
  protected void drawDataSet(Canvas c, IBubbleDataSet dataSet) {
    ...
    for (int j = mXBounds.min; j <= mXBounds.range + mXBounds.min; j++) {
      ...
      float shapeHalf =
        getShapeSize(entry.getSize(), dataSet.getMaxSize(), referenceSize, normalizeSize) / 2f;
