...
import com.sofar.chart.utils.FSize;
...
public class XAxisRenderer extends AxisRenderer {
  ...
  public void computeAxis(float min, float max, boolean inverted) {
    ...
    if (mViewPortHandler.contentWidth() > 10 && !mViewPortHandler.isFullyZoomedOutX()) {
      ...
      MPPointD p1 =
        mTrans.getValuesByTouchPoint(mViewPortHandler.contentLeft(), mViewPortHandler.contentTop());
      MPPointD p2 = mTrans
        .getValuesByTouchPoint(mViewPortHandler.contentRight(), mViewPortHandler.contentTop());
  ...
  public void renderGridLines(Canvas c) {
    ...
    int start = mXAxis.isDrawFirstGridLine() ? 0 : 2;
