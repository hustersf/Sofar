package com.sofar.profiler.refelection;
...
public class Reflector {
  ...
  protected void check(@Nullable Object caller, @Nullable Member member, @NonNull String name)
    throws ReflectedException {
    if (member == null) {
  ...
  protected Method findMethod(@NonNull String name, @Nullable Class<?>... parameterTypes)
