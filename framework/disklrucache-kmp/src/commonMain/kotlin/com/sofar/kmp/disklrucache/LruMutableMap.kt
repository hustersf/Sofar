...
internal fun <K : Any, V : Any> lruMutableMap(
  initialCapacity: Int = 0,
  loadFactor: Float = 0.75f,
): MutableMap<K, V> = LruMutableMapImpl(LinkedHashMap(initialCapacity, loadFactor))

internal class LruMutableMapImpl<K : Any, V : Any>(
