package com.sofar.chart.components;
...
public interface IMarker {
   ...
   *             You can adjust the offset conditionally based on this argument.
   * @return The offset for drawing at the specific `point`. This allows conditional adjusting
  ...
  /**
   * This method enables a specified custom IMarker to update it's content every time the
   * IMarker is redrawn.
   *
   * @param e         The Entry the IMarker belongs to. This can also be any subclass of Entry,
   *                 like BarEntry or
   *                  CandleEntry, simply cast it at runtime.
   * @param highlight The highlight object contains information about the highlighted value
   *                  such as it's dataset-index, the
