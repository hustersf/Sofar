...
import com.sofar.chart.interfaces.dataprovider.ScatterDataProvider;
import com.sofar.chart.renderer.ScatterChartRenderer;
...
public class ScatterChart extends BarLineChartBase<ScatterData> implements ScatterDataProvider {
  ...
  /**
   * Predefined ScatterShapes that allow the specification of a shape a ScatterDataSet should
   * be drawn with.
