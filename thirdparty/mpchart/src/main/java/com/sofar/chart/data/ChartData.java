...
public abstract class ChartData<T extends IDataSet<? extends Entry>> {
   ...
   * Tell DataSets to recalculate their min and max y-values, this is only needed for
   * autoScaleMinMax.
   *
  ...
  /**
   * Returns the index of the provided DataSet in the DataSet array of this data object, or -1
