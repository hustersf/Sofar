package com.sofar.chart.listener;
...
import com.sofar.chart.charts.BarLineChartBase;
import com.sofar.chart.charts.HorizontalBarChart;
...
public class BarLineChartTouchListener
  extends ChartTouchListener<BarLineChartBase<? extends BarLineScatterCandleBubbleData<?
  ...
  public void computeScroll() {
    ...
    float dragDistanceX =
      mChart.isDragXEnabled() ? mDecelerationCurrentPoint.x - mTouchStartPoint.x : 0.f;
    float dragDistanceY =
      mChart.isDragYEnabled() ? mDecelerationCurrentPoint.y - mTouchStartPoint.y : 0.f;
