...
public interface IDataSet<T extends Entry> {
  ...
  /**
   * Adds an Entry to the DataSet dynamically.
   * Entries are added to their appropriate index in the values array respective to their
   * x-position.
   * This will also recalculate the current minimum and maximum
   * values of the DataSet and the value-sum.
   *
   ...
   * contains. This is only used for performance reasons when only one color is in the colors
   * array (size == 1)
   *
   * @return
   */
   ...
   * <p>
   * For Pie and Radar chart it will be (y offset, distance from center offset); so if you want
   * icon to be rendered under value, you should increase X component of CGPoint, and if you want
   * icon to be rendered closet to center, you should decrease height component of CGPoint.
   *
   * @param offset
   */
